...
export default function App({ Component, pageProps, router }) {
  ...
  const description =
    meta.metaDescription || meta.description || 'Functional utility library - modern, simple, typed, powerful'
  ...
  return (
    <>
      <Title suffix="Exobase">{meta.metaTitle || meta.title}</Title>
      <Head>
        <meta key="twitter:card" name="twitter:card" content="summary_large_image" />
        <meta key="twitter:site" name="twitter:site" content="@repsofsunshine" />
        <meta key="twitter:description" name="twitter:description" content={description} />
        <meta
          key="twitter:image"
          name="twitter:image"
          content={`https://exobase-js-docs.vercel.app${socialCardLarge}`}
        />
        <meta key="twitter:creator" name="twitter:creator" content="@repsofsunshine" />
        <meta
          key="og:url"
          property="og:url"
          content={`https://exobase-js-docs.vercel.app${router.pathname}`}
        />
